...
{
    public class EnemyInvertedControls : Sprite, IPowerUp
    {
        ...
        public void PowerUp(Tank poweredTank, List<Tank> otherTanks)
        {
            ...
            {
                if (otherTank != _tank)
                    otherTank.Vehicle.RotationSpeed *= -1;
            }
        }
        ...
        {
            Texture = TankGame.GlobalContent.Load<Texture2D>("EnemyInvertedControls");
